...
then
    ...
    base=$dir/meta/${pheno[$i]}_genome_SAS.gz
fi
...
do
    ~/prsice/PRSice_linux \
	--target /sc/arion/projects/psychgen/projects/prs/cross_population_prs_development/analysis/quick_ridge/result/chr# \
	--ld /sc/arion/projects/psychgen/projects/prs/cross_population_prs_development/analysis/quick_ridge/result/chr# \
	--ld-keep ${ld_ids[$j]} \
	--base $base \
	--thread 4 \
	--beta BETA \
