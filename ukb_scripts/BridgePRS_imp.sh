...
do
	...
	--indir /sc/arion/work/hoggac01/ukb_pheno_results/$pheno/test_imputed \
	--outdir /sc/arion/projects/psychgen/projects/prs/cross_population_prs_development/quick_ridge/results/imputed/test11/$pheno \
	--pop1 EUR \
	--pop2 $pop2 \
	--pop2_test_data /sc/arion/projects/psychgen/projects/prs/cross_population_prs_development/quick_ridge/hapmap/phenotype/$pheno/$pheno-$pop22-$type-trim.target \
	--pop2_valid_data /sc/arion/projects/psychgen/projects/prs/cross_population_prs_development/quick_ridge/hapmap/phenotype/$pheno/$pheno-$pop22-$type-trim.valid \
	--cov_names $cov_names \
