...
do
	...
	--ld /sc/arion/projects/data-ark/ukb/application/ukb18177/genotyped/ukb18177 \
	--ld-keep ${ld_ids[$j]} \
	--base $base \
	--thread 4 \
	--beta BETA \
	...
	--extract /sc/arion/projects/psychgen/projects/prs/cross_population_prs_development/quick_ridge/geno/$pop.qced.snps.snplist \
	--print-snp \
	--cov-col $cov_names \
	--pheno-col Phenotype \
	--A1 A1 \
