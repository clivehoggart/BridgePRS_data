#BSUB -L /bin/sh
#BSUB -n 4
#BSUB -J csx[698,2792,2794,2795,4653,4803,4813,4898,4899,5191]
#BSUB -R "span[hosts=1]"
#BSUB -q premium
#BSUB -W 12:00
#BSUB -P acc_psychgen
...
file1='/hpc/users/hoggac01/1000G/csx_index_wo.dat'
...
outdir=$dir/csx25.ukb/$pheno.${pops[$i]}.$causal
mkdir $outdir
...
~/PRScsx/PRScsx.py \
    --ref_dir=/sc/arion/projects/psychgen/projects/prs/cross_population_prs_development/software/PRScsx/ukb \
